...
if __name__ == "__main__":
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            st.markdown("<style>@import url('https://fonts.googleapis.com/css2?family=Lobster&display=swap'); h1 {font-family: 'Lobster', cursive;} a {color: white;text-decoration: none; transition: color 0.2s;} a:visited {color: white;} a:hover{color: #7D8C1F; text-decoration: none;}</style><h1 style='text-align: center;'><a href='https://quizzo.streamlit.app' target='_self'>Quizzo</a></h1>", unsafe_allow_html=True)
