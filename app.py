...
if __name__ == "__main__":
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            st.markdown("<style>a {color: white;text-decoration: none;} a:visited {color: white;} a:hover{color: #FFD700; text-decoration: none;}</style><h1 style='text-align: center;'><a href='https://quizzo.streamlit.app' target='_self'>Quizzo</a></h1>", unsafe_allow_html=True)
